...
class BertClassification(nn.Module):
    ...
    def forward(self, batch_token, batch_segment, batch_attention_mask):
        ...
        with torch.no_grad():
            print("batch_token:" + str(batch_token.size()))
            print(batch_token[0, :])

            print("attention_mask:" + str(batch_attention_mask.size()))
            print(batch_attention_mask[0, :])

            print("token_type_ids:" + str(batch_segment.size()))
            print(batch_segment[0, :])
            ...
            print("out last hidden state size:" + str(out.hidden_states[-1].size()))
